...
import sys
sys.path.insert(0, "/Users/ArloLOK/Developer/buck/buck/third-party/py/pathlib")
...
@provide_for_build
def ios_react_native_library(name, bundle_name, entry_path, deps=[], srcs=[], visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def apple_bundle(name, binary, extension, deps=[], headers={}, info_plist=None, info_plist_substitutions={}, tests=[], xcode_product_type=None, visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def apple_binary(name, compiler_flags=[], configs={}, deps=[], exported_deps=[], exported_headers=None, exported_linker_flags=[], exported_preprocessor_flags=[], extra_xcode_sources=[], frameworks=[], gid=None, header_path_prefix=None, headers=None, lang_preprocessor_flags={}, linker_flags=[], prefix_header=None, preprocessor_flags=[], srcs=[], tests=[], use_buck_header_maps=None, visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def cxx_python_extension(name, base_module=None, compiler_flags=[], cxx_runtime_type=None, deps=[], framework_search_paths=[], header_namespace=None, headers=None, lang_preprocessor_flags={}, lex_srcs=[], linker_flags=[], platform_compiler_flags=None, platform_headers=None, platform_linker_flags=None, platform_preprocessor_flags=None, platform_srcs=None, prefix_headers=[], preprocessor_flags=[], srcs=None, tests=[], yacc_srcs=[], visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def xcode_prebuild_script(name, cmd, visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def robolectric_test(name, annotation_processor_deps=[], annotation_processor_only=None, annotation_processor_params=[], annotation_processors=[], compiler=None, contacts=[], deps=[], exported_deps=[], extra_arguments=[], javac=None, javac_jar=None, labels=[], postprocess_classes_commands=[], proguard_config=None, provided_deps=[], resources=[], resources_root=None, run_test_separately=None, source=None, source_under_test=[], srcs=[], target=None, test_type=None, use_cxx_libraries=None, vm_args=[], visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def python_binary(name, base_module=None, deps=[], main=None, main_module=None, zip_safe=None, visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def python_library(name, base_module=None, deps=[], resources=None, srcs=None, zip_safe=None, visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def cxx_binary(name, compiler_flags=[], cxx_runtime_type=None, deps=[], framework_search_paths=[], header_namespace=None, headers=None, lang_preprocessor_flags={}, lex_srcs=[], link_style=None, linker_flags=[], platform_compiler_flags=None, platform_headers=None, platform_linker_flags=None, platform_preprocessor_flags=None, platform_srcs=None, prefix_headers=[], preprocessor_flags=[], srcs=None, tests=[], yacc_srcs=[], visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def prebuilt_cxx_library(name, deps=[], exported_linker_flags=[], exported_platform_linker_flags=None, header_only=None, include_dirs=[], lib_dir=None, lib_name=None, link_whole=None, provided=None, soname=None, visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def android_react_native_library(name, bundle_name, entry_path, deps=[], package=None, srcs=[], visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def python_test(name, base_module=None, contacts=[], deps=[], labels=[], resources=None, source_under_test=[], srcs=None, zip_safe=None, visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def xcode_postbuild_script(name, cmd, visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def cxx_library(name, compiler_flags=[], cxx_runtime_type=None, deps=[], exported_headers=None, exported_lang_preprocessor_flags={}, exported_linker_flags=[], exported_platform_headers=None, exported_platform_linker_flags=None, exported_platform_preprocessor_flags=None, exported_preprocessor_flags=[], force_static=None, framework_search_paths=[], header_namespace=None, headers=None, lang_preprocessor_flags={}, lex_srcs=[], link_whole=None, linker_flags=[], platform_compiler_flags=None, platform_headers=None, platform_linker_flags=None, platform_preprocessor_flags=None, platform_srcs=None, prefix_headers=[], preprocessor_flags=[], soname=None, srcs=None, supported_platforms_regex=None, tests=[], yacc_srcs=[], visibility=[], build_env=None):
  add_rule({
...
@provide_for_build
def cxx_test(name, compiler_flags=[], contacts=[], cxx_runtime_type=None, deps=[], framework=None, framework_search_paths=[], header_namespace=None, headers=None, labels=[], lang_preprocessor_flags={}, lex_srcs=[], link_style=None, linker_flags=[], platform_compiler_flags=None, platform_headers=None, platform_linker_flags=None, platform_preprocessor_flags=None, platform_srcs=None, prefix_headers=[], preprocessor_flags=[], source_under_test=[], srcs=None, tests=[], yacc_srcs=[], visibility=[], build_env=None):
  add_rule({
    'buck.type' : 'cxx_test',
    'name' : name,
    'compilerFlags' : compiler_flags,
...
@provide_for_build
def apple_test(name, extension, can_group=None, compiler_flags=[], configs={}, contacts=[], deps=[], exported_deps=[], exported_headers=None, exported_linker_flags=[], exported_preprocessor_flags=[], extra_xcode_sources=[], frameworks=[], gid=None, header_path_prefix=None, headers=None, info_plist=None, info_plist_substitutions={}, labels=[], lang_preprocessor_flags={}, linker_flags=[], prefix_header=None, preprocessor_flags=[], resource_prefix_dir=None, srcs=[], test_host_app=None, tests=[], use_buck_header_maps=None, xcode_product_type=None, visibility=[], build_env=None):
  add_rule({
    ...
    'prefixHeader' : prefix_header,
    'preprocessorFlags' : preprocessor_flags,
    'resourcePrefixDir' : resource_prefix_dir,
    'srcs' : srcs,
